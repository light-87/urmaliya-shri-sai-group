...
CREATE TABLE IF NOT EXISTS pins (
  ...
  CONSTRAINT valid_role CHECK (role IN ('ADMIN', 'EXPENSE_INVENTORY', 'INVENTORY_ONLY', 'REGISTRY_MANAGER', 'LEADS'))
);
...
CREATE TABLE IF NOT EXISTS backup_logs (
  ...
  "registryCount" INTEGER DEFAULT 0,
  "warehousesCount" INTEGER DEFAULT 0,
  "expenseAccountsCount" INTEGER DEFAULT 0,
